...
router.get("/fetch-all", adminVerification, adminController.fetchDataForDashboard);
router.get("/find-user-trainer", adminVerification, adminController.fetchNewUsersAndTrainers);
